					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex" style="text-transform:capitalize;">
								<h4 class="content-title mb-0 my-auto">Students </h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/
                                    <?= 
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <b>Class:</b>  <?php
                                                            ...
                                                            $cla_id = $this->db->get_where('bz_students', array('use_id' => $use_id))->row()->cla_id;
                                                            $sec_id = $this->db->get_where('bz_students', array('use_id' => $use_id))->row()->sec_id;
