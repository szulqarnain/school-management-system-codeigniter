				...
				<div class="container">
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<div class="d-flex my-xl-auto right-content">
                             ...
                             <a class="btn ripple btn-primary" href="<?= base_url('students/add'); ?>"><i class="typcn typcn-plus"></i>  Enrollment </a>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Students List</h4>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="example" class="table key-buttons text-md-nowrap">
                                            ...
                                            <?php 
                                                $j = 1; 
                                                $rec = $this->db->get_where('bz_students', array('sch_id' => $this->session->userdata['sch_id']))->result_array();
                                                foreach ($rec as $row): 
