			...
			<div class="main">
                ...
                <?php echo form_open_multipart('students/add');?>
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Students</h4>
                                    <span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Enrollment
                                </span> 
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
                            
                             <button name="addStudent" type="submit" class="btn ripple btn-primary"><i class="fas fa-download"></i> &nbsp;  Save  </button>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
                                        <div>
                                            <h6 class="card-title mb-1">Student Enrollment</h6>
