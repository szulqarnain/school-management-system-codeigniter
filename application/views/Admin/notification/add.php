            ...
            <div class="main">
                ...
                <div class="container">
                    ...
                    <?php echo form_open_multipart('notifications/submit');?>

                    <!-- breadcrumb -->
                    <div class="breadcrumb-header justify-content-between">
                        <div class="my-auto">
                            <div class="d-flex">
                                <h4 class="content-title mb-0 my-auto">Notification</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-12">
                                        ...
                                        <div class="col-sm-12 col-md-12 mg-t-12 mg-sm-t-0">
                                            ...
                                            <h6 class="card-title mb-1">Add Notifications</h6>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12  for-student" style="padding:0px;">
                                                    ...
                                                    <div class="col-sm-12 form-group">
                                                        ...
                                                        <input type="text" name="not_title" id="title"
                                                            class="form-control cla_list" required>
                                                    </div>


                                                    <div class="col-sm-12 form-group">
                                                        <label for="">Description</label>
                                                        <textarea name="not_description" id="description" cols="30"
                                                            rows="5" class="form-control cla_list" required></textarea>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 form-group">
                                                    <button style="width:100%;" name="submit" type="submit"
